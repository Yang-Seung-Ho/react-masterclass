...
function Home() {
  ...
  const { data: upcomingData, isLoading: upcomingLoading } =
    useQuery<IGetMoviesResult>(["movies", "popular"], getUpcomingMovies);
      ...
      {isLoading && upcomingLoading && topRatedIsLoading ? (
        ...
        <>
          ...
          <SliderBox style={{ marginTop: "-80px" }}>
            <Slider>
              <BundleName>Now Playing</BundleName>
                ...
                {PclickedMovie && (
                  <>
                    ...
                    >
                      ...
                      ></BigCover>
                      <BigTitle>{PclickedMovie.title}</BigTitle>
                ...
                {TclickedMovie && (
                  <>
                    ...
                    >
                      ...
                      ></BigCover>
                      <BigTitle>{TclickedMovie.title}</BigTitle>
